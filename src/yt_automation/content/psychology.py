...
ACTION_VOCAB = [
    ...
    "mind_blown", "salute", "finger_guns", "mic_drop", "lean", "arms_crossed",
]
...
_DEFAULT_INTENSITY = {
    ...
    "stomp": 0.9, "mind_blown": 0.95, "salute": 0.6, "finger_guns": 0.75,
    "mic_drop": 0.9, "lean": 0.55, "arms_crossed": 0.6,
}
...
CURATED: dict[str, StickScript] = {
    ...
    "loss aversion": StickScript(
        title="Why Losing Hurts Twice As Much As Winning",
        description="Your brain is wired to fear loss far more than it loves a win. Loss aversion quietly runs your money, your habits, and your fear of change.",
        tags=["psychology", "loss aversion", "money psychology", "behavioral economics",
              "decisions", "self improvement", "shorts"],
        beats=[
            _b("Losing a hundred dollars hurts more than winning it feels good.", "facepalm", "OUCH", 0.8),
            _b("That's loss aversion — and it runs your whole life.", "point", "LOSS AVERSION", 0.85),
            _b("Your brain weighs a loss about twice as heavy as a gain.", "mind_blown", "2X", 0.95),
            _b("It kept your ancestors alive. Lose food, you die.", "panic", "SURVIVE", 0.85),
            _b("Now it keeps you in dead-end jobs and bad relationships.", "fall", "STUCK", 0.75),
            _b("You cling to what you have, terrified to lose it.", "arms_crossed", "CLING", 0.65),
            _b("Flip it: ask what you lose by NOT changing.", "idea", "REFRAME", 0.85),
            _b("The biggest risk is usually staying exactly where you are.", "power", "MOVE", 0.9),
            _b("Follow for the psychology of better decisions.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "cognitive dissonance": StickScript(
        title="Why You Defend Decisions You Know Are Wrong",
        description="When your actions clash with your beliefs, your brain rewrites the story instead of admitting it was wrong. That's cognitive dissonance.",
        tags=["psychology", "cognitive dissonance", "bias", "self awareness",
              "decisions", "mental models", "shorts"],
        beats=[
            _b("Ever defended a choice you secretly knew was wrong?", "shrug", "ADMIT IT", 0.75),
            _b("Your brain hates holding two clashing ideas at once.", "facepalm", "CLASH", 0.7),
            _b("It's called cognitive dissonance.", "point", "DISSONANCE", 0.85),
            _b("So instead of changing, you change the story.", "mind_blown", "REWRITE", 0.9),
            _b("Smokers convince themselves the risk is overblown.", "think", "EXCUSES", 0.6),
            _b("You bought it, so suddenly it's the best thing ever.", "lean", "JUSTIFY", 0.65),
            _b("Awareness breaks the spell. Catch yourself justifying.", "idea", "CATCH IT", 0.85),
            _b("Change the action, not the truth.", "power", "OWN IT", 0.9),
            _b("Follow to think clearer than everyone around you.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "the halo effect": StickScript(
        title="One Good Trait Makes Us Believe All The Rest",
        description="Attractive, confident, well-dressed — and suddenly we assume someone is also smart and kind. The halo effect quietly warps every first impression.",
        tags=["psychology", "halo effect", "first impressions", "bias",
              "social psychology", "self improvement", "shorts"],
        beats=[
            _b("We assume good-looking people are also smart and kind.", "point", "WE ASSUME", 0.75),
            _b("They're not. It's the halo effect.", "facepalm", "HALO EFFECT", 0.85),
            _b("One strong trait colours how we judge everything else.", "mind_blown", "ONE TRAIT", 0.9),
            _b("A confident voice makes weak ideas sound true.", "lean", "CONFIDENCE", 0.7),
            _b("A sharp suit makes us trust an empty promise.", "point_up", "THE SUIT", 0.7),
            _b("It's why brands pay millions for one beautiful face.", "power", "MILLIONS", 0.8),
            _b("Judge the argument, not the packaging.", "arms_crossed", "LOOK CLOSER", 0.8),
            _b("And yes — use it on your own first impression.", "finger_guns", "USE IT", 0.85),
            _b("Follow for the psychology hiding in plain sight.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "imposter syndrome": StickScript(
        title="The Smarter You Are, The More You Doubt Yourself",
        description="If you feel like a fraud about to be exposed, you're in good company — imposter syndrome hits the competent hardest. Here's how to beat it.",
        tags=["psychology", "imposter syndrome", "confidence", "self doubt",
              "mindset", "mental health", "shorts"],
        beats=[
            _b("Do you feel like a fraud about to be exposed?", "think", "FRAUD?", 0.75),
            _b("That's imposter syndrome — and it targets the competent.", "point", "IMPOSTER", 0.85),
            _b("The more you learn, the more you see what you don't know.", "mind_blown", "YOU SEE MORE", 0.9),
            _b("So skill quietly grows while confidence lags behind.", "shrug", "THE GAP", 0.65),
            _b("Meanwhile the clueless feel like total experts.", "facepalm", "IRONY", 0.7),
            _b("Feeling like an imposter can mean you're actually growing.", "idea", "GROWTH", 0.85),
            _b("Keep the receipts. Write down what you've actually done.", "point_up", "RECEIPTS", 0.8),
            _b("You're not a fraud. You're just paying attention.", "power", "NOT A FRAUD", 0.9),
            _b("Follow if your brain needs to hear this daily.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "parkinson's law": StickScript(
        title="Work Expands To Fill The Time You Give It",
        description="Give a task a week and it takes a week. Give it an hour and it's somehow done. Parkinson's Law is the productivity cheat code nobody uses.",
        tags=["psychology", "parkinsons law", "productivity", "time management",
              "discipline", "self improvement", "shorts"],
        beats=[
            _b("Give yourself a week for a task, it takes a week.", "facepalm", "A WEEK", 0.7),
            _b("Give yourself an hour, and somehow it's done.", "mind_blown", "AN HOUR", 0.9),
            _b("That's Parkinson's Law.", "point", "PARKINSON", 0.85),
            _b("Work expands to fill the time you give it.", "point_up", "EXPANDS", 0.8),
            _b("Loose deadlines breed overthinking and busywork.", "think", "BUSYWORK", 0.6),
            _b("So shrink the clock on purpose.", "finger_guns", "SHRINK IT", 0.8),
            _b("Set a timer that scares you a little.", "stomp", "TIMER", 0.85),
            _b("Constraints don't kill quality. They force focus.", "power", "FOCUS", 0.9),
            _b("Follow and stop letting tasks steal your week.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "anchoring bias": StickScript(
        title="The First Number You Hear Hijacks Your Brain",
        description="The first price, the first offer, the first number — it secretly anchors every judgment that follows. Anchoring bias is why you overpay.",
        tags=["psychology", "anchoring bias", "negotiation", "money psychology",
              "decisions", "behavioral economics", "shorts"],
        beats=[
            _b("The first number you hear quietly controls the rest.", "point", "FIRST NUMBER", 0.8),
            _b("It's called anchoring — and it's everywhere.", "mind_blown", "ANCHORING", 0.9),
            _b("A 1000 dollar price tag makes 600 feel like a steal.", "lean", "A STEAL?", 0.75),
            _b("Even random numbers shift what you'll pay.", "facepalm", "RANDOM", 0.7),
            _b("Stores show the high price first on purpose.", "arms_crossed", "ON PURPOSE", 0.7),
            _b("Negotiations are won by whoever anchors first.", "finger_guns", "ANCHOR FIRST", 0.85),
            _b("So name your number before they name theirs.", "power", "GO FIRST", 0.9),
            _b("And question every anchor someone hands you.", "point_up", "QUESTION IT", 0.8),
            _b("Follow for the psychology of money and influence.", "cheer", "FOLLOW", 0.85),
        ],
    ),
    "the paradox of choice": StickScript(
        title="Why More Options Make You Less Happy",
        description="Endless choices feel like freedom but quietly drain you. The paradox of choice explains why a giant menu leaves you unsatisfied.",
        tags=["psychology", "paradox of choice", "decision fatigue", "minimalism",
              "happiness", "self improvement", "shorts"],
        beats=[
            _b("More choices feel like freedom. They're often a trap.", "shrug", "THE TRAP", 0.75),
            _b("It's the paradox of choice.", "point", "PARADOX", 0.85),
            _b("Too many options and your brain just freezes.", "panic", "FREEZE", 0.9),
            _b("Pick one, and you mourn all the ones you didn't.", "fall", "REGRET", 0.7),
            _b("A giant menu leaves you less happy with your meal.", "facepalm", "THE MENU", 0.65),
            _b("That's decision fatigue draining you all day.", "think", "FATIGUE", 0.6),
            _b("Cut your options on purpose. Set defaults.", "idea", "FEWER", 0.85),
            _b("Constraints aren't a cage. They're freedom.", "power", "FREEDOM", 0.9),
            _b("Follow to make your brain's life easier.", "cheer", "FOLLOW", 0.85),
        ],
    ),
}
